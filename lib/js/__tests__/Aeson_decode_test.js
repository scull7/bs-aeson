...
describe("date with float", (function () {
        var now = new Date("2017-12-08T06:03:22.123Z");
        return Jest.test("date", (function () {
                      return Jest.Expect[/* toEqual */12](now, Jest.Expect[/* expect */0](Aeson_decode.date(Aeson_encode.date(now))));
                    }));
      }));

describe("date with trailing float zeros", (function () {
        var now = new Date("2017-12-08T06:03:22.000Z");
        return Jest.test("date", (function () {
                      return Jest.Expect[/* toEqual */12](now, Jest.Expect[/* expect */0](Aeson_decode.date(Aeson_encode.date(now))));
                    }));
      }));
